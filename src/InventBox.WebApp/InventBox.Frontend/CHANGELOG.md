...
- Create Angular project with ng: `ng new inventbox.webapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`inventbox.webapp.client.esproj`).
